package dataclean.weblog.pageview;

import dataclean.weblog.preprocess.WebLogBean;
...
//		FileOutputFormat.setOutputPath(job, new Path(args[1]));
        ...
        FileInputFormat.setInputPaths(job, new Path("E:\\hadooptemp\\1output"));
        FileOutputFormat.setOutputPath(job, new Path("E:\\hadooptemp\\2output"));
