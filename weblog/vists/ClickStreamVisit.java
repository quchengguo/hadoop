package dataclean.weblog.vists;

import dataclean.weblog.pageview.PageViewsBean;
...
//		FileOutputFormat.setOutputPath(job, new Path(args[1]));
		FileInputFormat.setInputPaths(job, new Path("E:\\hadooptemp\\2output"));
		FileOutputFormat.setOutputPath(job, new Path("E:\\hadooptemp\\3output"));
